...
CHEF_SERVER_NAME="pj-chef-automate" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="pj-chef-automate-3nv1uetadbn62y0t.us-west-2.opsworks-cm.io" # The FQDN of your Chef Server
REGION="us-west-2" # Region of your Chef Server (Choose one of our supported regions - us-east-1, us-east-2, us-west-1, us-west-2, eu-central-1, eu-west-1, ap-northeast-1, ap-southeast-1, ap-southeast-2)
