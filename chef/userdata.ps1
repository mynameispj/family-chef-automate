<powershell>
 ...
 $env:CHEF_SERVER_NAME = "pj-chef-automate" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "pj-chef-automate-3nv1uetadbn62y0t.us-west-2.opsworks-cm.io" # FQDN of your Chef Server
